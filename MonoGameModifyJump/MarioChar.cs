...
namespace MonoGameModifyJump
{
    ...
    public class MarioChar : Sprite
    {
        ...
        public void UpdateMarioCharMove(float time)
        {
        ...
        /// </summary>
        public void UpdateKeepMarioCharOnScreen(GraphicsDevice graphics)
        {
            //Keep MarioCharacters On Screen
            if (
                //X right
                (this.Loc.X >
