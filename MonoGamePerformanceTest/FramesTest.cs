...
{
    internal class FramesTest : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public FramesTest(Game game, bool synchWithVerticalRetrace, bool isFixedTimeStep) : this(game, synchWithVerticalRetrace, isFixedTimeStep, game.TargetElapsedTime)
        {

        }

        public FramesTest(Game1 game) : this(game, false, false)
        { 
